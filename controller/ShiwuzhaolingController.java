...
public class ShiwuzhaolingController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShiwuzhaolingEntity shiwuzhaoling, 
		...
		if(tableName.equals("yonghu")) {
			shiwuzhaoling.setusername((String)request.getSession().getAttribute("username"));
		}
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        ShiwuzhaolingEntity shiwuzhaoling = shiwuzhaolingService.selectById(id);
        if(type.equals("1")) {
        	shiwuzhaoling.setThumbsupnum(shiwuzhaoling.getThumbsupnum()+1);
        } else {
        	shiwuzhaoling.setCrazilynum(shiwuzhaoling.getCrazilynum()+1);
        }
