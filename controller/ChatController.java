...
public class ChatController {
	...
	@GetMapping("/users")
	public List<YonghuEntity> getUsersWithoutCurrentUser( HttpServletRequest request){
		Long userId = (Long) request.getSession().getAttribute("userId");
		List<YonghuEntity> list = yonghuService.getUsersWithoutCurrentUser(userId);
		List<UserEntity> userList = userService.selectListView(new EntityWrapper<UserEntity>().ne("id", userId));
		userList.forEach(user -> {
			YonghuEntity yonghuEntity = new YonghuEntity();
			yonghuEntity.setUserStateId(user.getUserStateId());
			yonghuEntity.setId(user.getId());
			yonghuEntity.setUsername(user.getUsername());
			yonghuEntity.setYonghuxingming(user.getYonghuxingming());
			yonghuEntity.setTouxiang(user.getTouxiang());
