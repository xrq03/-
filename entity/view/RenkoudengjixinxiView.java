...
public class RenkoudengjixinxiView extends RenkoudengjixinxiEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	public RenkoudengjixinxiView(){
	}

 	public RenkoudengjixinxiView(RenkoudengjixinxiEntity zufangxinxiEntity){
 	try {
